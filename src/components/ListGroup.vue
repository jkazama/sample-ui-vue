...
<template>
<div class="l-list-group-body p-1" :class="{'l-scrollable': fixed}" :style="styleData" @scroll="scroll">
  <ul class="list-group">
    <li class="list-group-item text-center" v-show="updating">
      <font-awesome-icon icon="spinner" spin v-if="updating" />
    </li>
    <slot />
  </ul>
</div>
